...
<body>
	...
	<ul >
			...
			<div id="main">
				<div id="main2"></div>
				<h2>  Geetika Paliwal</h2>
				    

			    <p> I am pursuing B.Tech. in CSE from Graphic Era Hill University, Uttrakhand.
					I am keen about web development. 
                    I have worked on programming languages such as HTML, CSS, JavaScript, PHP, MYSQL, PYTHON and JAVA .
			
			<br>I am looking for an mentor who can provides me the guidance to improve
